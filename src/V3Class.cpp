...
private:
  ...
  virtual void visit(AstClass *nodep) override {
    ...
    AstCell *cellp = new AstCell(packagep->fileline(), packagep->fileline(),
                                 packagep->name(), packagep->name(), nullptr,
                                 nullptr, nullptr);
    cellp->modp(packagep);
...
void V3Class::classAll(AstNetlist *nodep) {
  ...
  V3Global::dumpCheckGlobalTree("class", 0,
