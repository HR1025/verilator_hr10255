...
void test(const string &lhss, const string &op, const string &rhss,
          const string &exps) {
...
int main() {
  ...
  test("57'h000000010F0CCE7", "*", "57'h0DE34E7FFFFFFFF",
       "57'h02A9D57EF0F3319");
  test("67'h7FFFFFFFFFFFFFFFF", "*", "67'h4000000003C8A8D6A",
       "67'h3FFFFFFFFC3757296");
