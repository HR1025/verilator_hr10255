...
///
///     "L|R":
///     ...->DfaVtx-->[epsilon]-->DfaVtx-->[ON_L]-->DfaVtx()->[epsilon]-->DfaVtx(ACCEPT)
...
public:
  // CONSTRUCTORS
  explicit DfaVertex(DfaGraph *graphp, bool start = false,
                     bool accepting = false)
      : V3GraphVertex{graphp}, m_start{start}, m_accepting{accepting} {}
  using V3GraphVertex::clone; // We are overriding, not overloading
                              // clone(V3Graph*)
...
public:
  ...
  // CONSTRUCTORS
  DfaEdge(DfaGraph *graphp, DfaVertex *fromp, DfaVertex *top,
          const DfaInput &input)
      : V3GraphEdge{graphp, fromp, top, 1}, m_input{input}, m_complement{
                                                                false} {}
  DfaEdge(DfaGraph *graphp, DfaVertex *fromp, DfaVertex *top,
          const DfaEdge *copyfrom)
