...
private:
  ...
  // STATE
  // Reset each module:
  AstSenItem *m_seniDefaultp =
      nullptr; // Default sensitivity (from AstDefClock)
  ...
  virtual void visit(AstImplication *nodep) override {
    ...
    if (m_disablep)
      lhsp = new AstAnd(fl, new AstNot(fl, m_disablep), lhsp);
...
void V3AssertPre::assertPreAll(AstNetlist *nodep) {
  ...
  V3Global::dumpCheckGlobalTree("assertpre", 0,
