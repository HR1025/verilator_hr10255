...
public:
  explicit VRestorer(T &permr) : m_ref{permr}, m_saved{permr} {}
...
public:
  ...
  enum en m_e;
  VWidthMinUsage() : m_e{LINT_WIDTH} {}
  // cppcheck-suppress noExplicitConstructor
  VWidthMinUsage(en _e) : m_e{_e} {}
...
class V3Global final {
  ...
  V3HierBlockPlan
      *m_hierPlanp; // Hierarchical verilation plan, nullptr unless hier_block
  ...
  bool m_useRandomizeMethods =
      false; // Need to define randomize() class methods
...
public:
  ...
  V3Global()
      : m_rootp{nullptr}
        ...
        ,
        m_hierPlanp{nullptr}
        // Set via hierPlanp(V3HierBlockPlan*} when use hier_block
        ,
