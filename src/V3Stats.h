...
public:
  ...
  explicit VDouble0(const vluint64_t v) : m_d{static_cast<double>(v)} {}
...
public:
  ...
  // CONSTRUCTORS
  V3Statistic(const string &stage, const string &name, double count,
...
public:
  ...
  static void statsStageAll(AstNetlist *nodep, const string &stage,
                            bool fast = false);
