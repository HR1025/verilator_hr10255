...
public:
  ...
  static std::ofstream *new_ofstream(const string &filename,
                                     bool append = false) {
...
public:
  ...
  void indentDec() {
    ...
    UASSERT(m_indentLevel >= 0,
            ": " << m_filename << ": Underflow of indentation");
  }
...
//============================================================================
// V3OutFile: A class for printing to a file, with automatic indentation of C++
// code.
